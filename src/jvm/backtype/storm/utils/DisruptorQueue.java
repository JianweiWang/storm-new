...
public class DisruptorQueue {
    ...
    /**
     * add by wjw 2014-05-13 09:40
     * @return the usage of disruptor
     */
    public double getUsage() {
    	int size = _buffer.getBufferSize();
    	long remain = _buffer.remainingCapacity();
    	double usage =  1 - ((double) remain /(double)size);
    	return usage;
    }//end wjw
